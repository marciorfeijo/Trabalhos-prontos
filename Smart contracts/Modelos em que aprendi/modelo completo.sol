...
/**
 * @title AngelsHearts Token
 * @dev Token representing ANGELS.
 */
contract AngelsHearts is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(700000000).mul(10 ** uint256(decimals)); //Update total supply with the decimal amount
    name = "AngelsHearts";
    symbol = "ANGELS";
